        ...
        <div className='w-full h-fit flex flex-col gap-4'>
            <div className='flex gap-1 items-center'>
                <div className="flex flex-row w-fit items-center gap-4">
                    <span dir={i18n.dir()} className="text-primary text-sm"> {t("traveling.title")} </span>
            ...
            <div className='relative'>
                <div className='flex justify-between w-full flex-wrap items-center gap-4'>
                    <div className='flex gap-4'>
                        <h2 dir={i18n.dir()} className='lg:text-2xl md:text-xl text-base font-[500]'> {t("traveling.subtitle")} </h2>
                    </div>
