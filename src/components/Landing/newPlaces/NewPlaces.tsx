...
const NewPlaces = () => {
    const t = useTranslations('landing.newPlaces');
        ...
        after:rounded-tl-[70px]">
            <div className='flex gap-1 items-center'>
                <div className="flex flex-row w-fit items-center gap-4">
                    <span className="text-primary text-sm">{t('newestPoints')}</span>
            ...
            <div className='relative'>
                <div className='flex justify-between w-full flex-wrap items-center gap-4'>
                    <div className='flex gap-4'>
                        <h2 className='lg:text-2xl md:text-xl text-base font-[500]'>{t('newestRecreationalAreas')}</h2>
                    </div>
