...
const PassengersModal = () => {
    ...
    return (
        <Dialog onOpenChange={setOpen} open={open} >
            <DialogTrigger>
                <CommonButton title='مسافر ها' classname='bg-primary text-primary-foreground' />
            </DialogTrigger>
                        ...
                        <Table className='text-right w-full overflow-hidden'>
                            <TableHeader className='bg-subBg2 rounded-2xl text-foreground'>
                                <TableRow className='text-right'>
                                    ...
                                    <TableHead className='text-right text-foreground'> جنسیت </TableHead>
                                    <TableHead className='text-right text-foreground'> شماره تماس </TableHead>
                                    <TableHead className='text-right text-foreground'> ارسال پیام </TableHead>
                                </TableRow>
                            </TableHeader>
                            <TableBody>
