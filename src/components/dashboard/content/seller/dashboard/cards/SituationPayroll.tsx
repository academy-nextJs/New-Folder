        ...
        <BlurFade delay={0.50} className='w-1/2 max-lg:w-full min-h-full rounded-[12px] bg-subBg flex gap-4 px-4 py-4 flex-col'>
            <div className='flex justify-between w-full items-center'>
                <div className='flex gap-2 w-fit items-center'>
                    <CreditCard size={24} />
                    <span className='text-base font-bold'> آمار درآمد ها </span>
                </div>
            </div>
            ...
            <div className='flex flex-col w-full justify-between gap-8 h-fit'>
                <div className='w-full flex justify-between'>
                    <div className='flex gap-2 items-center'> <div className='bg-primary rounded-full w-[16px] h-[16px]' /> <span className='font-semibold'> درآمد ماه جاری </span> </div>
                    <CommonButton title=' 115،000،000     تومان ' />
                </div>
                <div className='w-full flex justify-between'>
                    <div className='flex gap-2 items-center'> <div className='bg-subBg2 rounded-full w-[16px] h-[16px]' /> <span className='font-semibold'> درآمد ماه جاری </span> </div>
