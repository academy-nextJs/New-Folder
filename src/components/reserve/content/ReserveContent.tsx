...
const ReserveContent = () => {
    return (
        <div className='flex xl:flex-row flex-col gap-4 justify-between w-full h-[1080px] overflow-hidden rounded-[40px] bg-secondary-light2 p-4'>
            <div className='flex gap-6 flex-col xl:w-3/5 w-full'>
                ...
                <div className='flex flex-col gap-6 overflow-y-scroll rtl'>
                    <ReserveCard />
                    <ReserveCard />
                    <ReserveCard />
                    <ReserveCard />
