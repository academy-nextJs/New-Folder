...
const AnimationForm = () => {
    return (
        <motion.div initial={{ rotate: "180deg" }} whileInView={{ rotate: "0" }} transition={{ duration: 0.3 }} className='bg-[#3B3B3B] mx-[100px] min-w-[387.89453125] rounded-[32px] h-[365.8563232421875] my-auto relative flex justify-center items-center'>
