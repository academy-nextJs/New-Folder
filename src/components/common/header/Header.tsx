...
const Header = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center relative">
      ...
      <div className="w-[100%] mx-8 max-w-[1480px] flex items-center justify-between lg:h-[48px] md:h-[36px] h-[40px] my-8 relative bg-subBg text-subText rounded-[16px]  z-50">
        {/* Desktop Layout */}
