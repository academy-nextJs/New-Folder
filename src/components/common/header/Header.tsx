...
const Header = () => {
  ...
  return (
    <div className="w-full flex justify-center items-center relative">
      ...
      <div className="w-[95%] max-w-[1376px] mx-auto flex items-center justify-between lg:h-[48px] md:h-[36px] h-[40px] fixed top-[24px] bg-subBg text-subText rounded-[16px]  z-50">
        {/* Desktop Layout */}
            ...
            >
              <span
                className={`block w-5 h-0.5 bg-current transition-all duration-300 ${
                  isDrawerOpen ? "rotate-45 translate-y-1" : ""
                }`}
              ></span>
              <span
