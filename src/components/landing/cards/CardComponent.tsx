    ...
    return (
        <div className='flex flex-col gap-4 text-white group w-fit h-full my-10 mx-auto'>
            <div className='relative '>
                <div className="bg-[#393939] w-full p-4 group-hover:bg-primary relative h-[190] rounded-[24px] flex justify-center items-center after:content-['']
                        after:w-[90px] after:h-[50px] after:group-hover:bg-primary after:absolute after:top-[-34] after:rounded-tr-2xl after:rounded-tl-[40px] after:right-0 after:bg-[#393939]">
                    ...
                    <div className='bg-[#393939] cursor-pointer text-white px-2 text-sm rounded-[10px] absolute top-[-30] left-0'>
